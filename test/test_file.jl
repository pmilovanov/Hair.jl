...
@testset "File utils" begin
  ...
  @testset "Basic read binary data" begin
    ...
    c = Channel(100); @async H.read_images_masks_from_dir(c, tdir)
    @test [String.(x) for x in c] == [("1.png", "1-mask.png"), ("2.png", "2-mask.png"), ("3.png", "3-mask.png")]
  end
